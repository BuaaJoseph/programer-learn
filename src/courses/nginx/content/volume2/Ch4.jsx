  ...
  return (
    <>
      ...
      <p>
        ...
        以及<strong>健康检查脚本</strong>（探测 Nginx 进程，挂了降优先级触发漂移）。能讲到脑裂，基本就拉开差距了。
      </p>
      ...
      <Summary
        points={[
          ...
          '脑裂是心跳断导致主备同时抢 VIP，靠独立心跳线、第三方仲裁和认证来防范。',
          '必须配 vrrp_script 健康检查脚本探测 Nginx 进程，失败时降优先级触发 VIP 漂移。',
          '配置上 virtual_router_id 主备一致、priority 主备不同、virtual_ipaddress 填同一 VIP。',
        ]}
      />
    </>
  )
